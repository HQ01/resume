...
\affiliation{Robinhood}{Software Engineer}{Python}{July 2016 | Present}
\begin{itemize*}
\item Automating the processing and handling of corporate actions, particularly instrument reorgs
\end{itemize*}
\vspace{-1mm}

\affiliation{Accompany}{Software Engineer Intern}{Ruby/Rails, SQL}{June 2015 | September 2015}
\begin{itemize*}
...
\affiliation{Palantir}{Forward Deployed Engineer (Philanthropy Team)}{Java, SQL, Python}{May 2013 | September 2014}
\begin{itemize*}
...
\affiliation{TripAdvisor}{Software Engineer Intern}{Java}{December 2011 | January 2012}
\begin{itemize*}
...
\affiliation{Apparition: Crowdsourced User Interfaces That Come To Life As You Sketch Them}{Advisor: Dr. Michael Bernstein, Stanford University}{JavaScript/Meteor}{Winter 2014 | Summer 2014}
\begin{itemize*}
